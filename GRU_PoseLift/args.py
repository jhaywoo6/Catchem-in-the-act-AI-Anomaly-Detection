...
def init_parser(default_data_dir='data/', default_exp_dir='data/exp_dir'):
    ...
    parser.add_argument('--prop_norm_scale', '-pns', type=int, default=8, metavar='PNS', choices=[0, 1], help='Scale keeping proportions [1/0] (default: 1)')
    ...
    parser.add_argument('--input_dim', type=int, default=2, help='Input feature dimension for GRU')
